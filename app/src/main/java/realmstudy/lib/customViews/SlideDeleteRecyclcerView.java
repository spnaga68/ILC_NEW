 ...
 */
public class SlideDeleteRecyclcerView extends RecyclerView {
    Context context;

    public SlideDeleteRecyclcerView(Context context) {
    ...
    public SlideDeleteRecyclcerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        setUpItemTouchHelper();
        setUpAnimationDecoratorHelper();
    ...
    public SlideDeleteRecyclcerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private void setUpItemTouchHelper() {
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            public int getSwipeDirs(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
                ...
                SlideRecyclerView slideRecyclerView = (SlideRecyclerView) recyclerView.getAdapter();
                if (slideRecyclerView.isUndoOn() && slideRecyclerView.isPendingRemoval(position)) {
                    return 0;
                }
